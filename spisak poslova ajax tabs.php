...
//  global $conn;
 ...
 function iscitavanje_tabele ($conn) {
        ...
        foreach ($conn->query($sql) as $row) {
            ...
            echo "<tr class='red-harmonika' id='$i-red' idfakture ='" . $row["faktura_id"] . "' idNaloga= '" . $row["id"] . "' brojReda='$i'>
                    <th>
                    ...
                    <th>
                        <button type='button' class='btn btn-default btn-xs phpFaktura-dugme'>" .$row["broj_fakture_cist"] . "</button>
                    </th>
                </tr>
                <tr class='collapse tamnija-bg'> 
                    <td colspan='8'>
                        <div id='" . $i . "-skriveni-red' brojReda='$i'>
